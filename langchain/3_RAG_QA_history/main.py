...
if api_key:
    ...
    if uploaded_files:
        ...
        vectorstor=FAISS.from_documents(documents=splits,embedding=embeddings)
        ...
        contextualize_q_system_prompt=(
            ...
            "just refrmulate if it needed and otherwise return it as it is."
        )
        ...
        system_prompt=(
                ...
                "the question. If you dont know the answer say thank you dont know."
        ...
        if user_input:
            ...
            response=conversational_rag_chain.invoke(
                {"input":user_input},
                config={
                    "configurable":{"session_id":session_history}
                },
